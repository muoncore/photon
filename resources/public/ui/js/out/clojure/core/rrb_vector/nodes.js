...
var slc = (rngs[(32)]);
var and__4549__auto__ = (slc === (32));
if(and__4549__auto__){
var or__4561__auto__ = (shift === (5));
if(or__4561__auto__){
return or__4561__auto__;
} else {
var G__13503 = (root.arr[(slc - (1))]);
var G__13504 = (shift - (5));
var G__13505 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__13503;
shift = G__13504;
cnt = G__13505;
continue;
...
var rngs_13514 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_13515 = (rngs_13514[(0)]);
var new_rngs_13516 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_13517 = (rngs_13514[(32)]);
cljs.core.array_copy.call(null,rngs_13514,(1),new_rngs_13516,(0),(lim_13517 - (1)));

var i_13518 = (0);
while(true){
if((i_13518 < lim_13517)){
(new_rngs_13516[i_13518] = ((new_rngs_13516[i_13518]) - rng0_13515));
...
(new_rngs_13516[(32)] = ((rngs_13514[(32)]) - (1)));

(new_rngs_13516[((rngs_13514[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_13516);
} else {
}
...
while(true){
if((i_13520 <= li)){
(new_rngs[i_13520] = ((new_rngs[(i_13520 - (1))]) + step));
...
while(true){
if((i_13522 <= li)){
(new_rngs[i_13522] = ((rngs[i_13522]) - d));
...
while(true){
if((j_13524 <= i)){
(rngs[j_13524] = r_13525);

var G__13526 = (j_13524 + (1));
var G__13527 = (r_13525 + step);
j_13524 = G__13526;
r_13525 = G__13527;
continue;
} else {
...
var rngs = ((!(reg_QMARK_))?(function (){var G__13529 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__13529[(0)] = node.arr.length);
...
var arr_13530__$1 = arr;
var shift_13531__$1 = shift;
while(true){
if((shift_13531__$1 === (5))){
if(!(reg_QMARK_)){
(arr_13530__$1[(32)] = rngs);
} else {
}

(arr_13530__$1[(0)] = node);
} else {
var a_13532 = (new Array(len));
var e_13533 = cljs.core.__GT_VectorNode.call(null,null,a_13532);
(arr_13530__$1[(0)] = e_13533);
...
var G__13534 = a_13532;
var G__13535 = (shift_13531__$1 - (5));
arr_13530__$1 = G__13534;
shift_13531__$1 = G__13535;
continue;
}
break;
}
...
var reg_QMARK_ = (function (){var and__4549__auto__ = clojure.core.rrb_vector.nodes.regular_QMARK_.call(null,node);
