...
var slc = (rngs[(32)]);
var and__29253__auto__ = (slc === (32));
if(and__29253__auto__){
var or__29265__auto__ = (shift === (5));
if(or__29265__auto__){
return or__29265__auto__;
} else {
var G__38149 = (root.arr[(slc - (1))]);
var G__38150 = (shift - (5));
var G__38151 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__38149;
shift = G__38150;
cnt = G__38151;
continue;
...
var rngs_38160 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_38161 = (rngs_38160[(0)]);
var new_rngs_38162 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_38163 = (rngs_38160[(32)]);
cljs.core.array_copy.call(null,rngs_38160,(1),new_rngs_38162,(0),(lim_38163 - (1)));

var i_38164 = (0);
while(true){
if((i_38164 < lim_38163)){
(new_rngs_38162[i_38164] = ((new_rngs_38162[i_38164]) - rng0_38161));

var G__38165 = (i_38164 + (1));
i_38164 = G__38165;
continue;
} else {
}
...
(new_rngs_38162[(32)] = ((rngs_38160[(32)]) - (1)));

(new_rngs_38162[((rngs_38160[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_38162);
} else {
}
...
while(true){
if((i_38166 <= li)){
(new_rngs[i_38166] = ((new_rngs[(i_38166 - (1))]) + step));

var G__38167 = (i_38166 + (1));
i_38166 = G__38167;
continue;
} else {
}
...
while(true){
if((i_38168 <= li)){
(new_rngs[i_38168] = ((rngs[i_38168]) - d));

var G__38169 = (i_38168 + (1));
i_38168 = G__38169;
continue;
} else {
}
...
while(true){
if((j_38170 <= i)){
(rngs[j_38170] = r_38171);

var G__38172 = (j_38170 + (1));
var G__38173 = (r_38171 + step);
j_38170 = G__38172;
r_38171 = G__38173;
continue;
} else {
...
var rngs = ((!(reg_QMARK_))?(function (){var G__38175 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__38175[(0)] = node.arr.length);
...
var arr_38176__$1 = arr;
var shift_38177__$1 = shift;
while(true){
if((shift_38177__$1 === (5))){
if(!(reg_QMARK_)){
(arr_38176__$1[(32)] = rngs);
} else {
}

(arr_38176__$1[(0)] = node);
} else {
var a_38178 = (new Array(len));
var e_38179 = cljs.core.__GT_VectorNode.call(null,null,a_38178);
(arr_38176__$1[(0)] = e_38179);
...
var G__38180 = a_38178;
var G__38181 = (shift_38177__$1 - (5));
arr_38176__$1 = G__38180;
shift_38177__$1 = G__38181;
continue;
}
break;
}
...
var reg_QMARK_ = (function (){var and__29253__auto__ = clojure.core.rrb_vector.nodes.regular_QMARK_.call(null,node);
